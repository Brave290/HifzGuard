...
class PreferencesHelper(private val context: Context) {
    ...
    private companion object {
        ...
        const val KEY_COMMITMENT_END_TIME = "commitment_end_time_millis"
    }
    ...
    var commitmentEndTimeMillis: Long
        get() = sharedPrefs.getLong(KEY_COMMITMENT_END_TIME, 0L)
        set(value) = sharedPrefs.edit().putLong(KEY_COMMITMENT_END_TIME, value).apply()
